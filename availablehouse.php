        ...
        <div class="well search_card card-body">
          <form class="search_house_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <select class="form-control" style="background-color:lavender;" name="house_type">
              ...
              <select class="form-control" style="background-color:lavender;" name="apartment_type">
                  <option value="" selected disabled>Ownership Type</option>
                  <option value="Owned"
                      <?php if(isset($_POST['apartment_type']) && $_POST['apartment_type']=='Owned'){
                          echo "selected";
                      } ?>
                  >Owned</option>
                  <option value="Rented"
                      <?php if(isset($_POST['apartment_type']) && $_POST['apartment_type']=='Rented'){
                          echo "selected";
                      } ?>
                  >Rented</option>
              </select>
