          ...
          <form enctype="multipart/form-data" class="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="house_type from-group" style="margin-bottom:15px;">
              <select class="form-control" id="select_type" style="background-color:lavender;" name="house_type" required>
                <option value="" selected disabled>Rent/Sale Type</option>
              ...
              <div class="house_type from-group" style="margin-bottom:15px;">
                  <select class="form-control" id="select_type" style="background-color:lavender;" name="apartment_type" required>
            ...
            <div class="fam_bac_sub">
              <div class="fam_bac_sub_inner">
                ...
                <div class="rent">
                  <label for="amount" style="margin-right:5px;">Rental/Sale Value :</label>
                ...
                <p class="text-center" style="margin-top:10px;">
                  <input type="submit" style="margin-bottom:0px;" class="btn btn-info" name="fam_add_rent" value="Add Your house">
                </p>
              </div>
            </div>
